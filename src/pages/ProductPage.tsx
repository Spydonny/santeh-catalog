    ...
    <div className="container-page py-8">
      ...
      <div className="mt-5 grid grid-cols-1 gap-10 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          <div>
            <span className="text-xs font-medium uppercase tracking-wide text-accent-600">{product.subcategory}</span>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="text-sm text-slate-500">Бренд: {product.brand}</span>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            <h2 className="mb-3 text-base font-semibold text-slate-900">Характеристики</h2>
      ...
      <section className="mt-14">
        <h2 className="mb-5 text-xl font-bold text-slate-900">
          Отзывы {reviews.length > 0 && <span className="text-slate-400">({reviews.length})</span>}
        </h2>
        {reviews.length === 0 ? (
          <p className="text-sm text-slate-500">По этому товару пока нет отзывов.</p>
        ) : (
          <div className="flex flex-col gap-4">
            {reviews.map((review) => (
      ...
      {related.length > 0 && (
        <section className="mt-14">
          <div className="mb-5 flex items-center justify-between">
            <h2 className="text-xl font-bold text-slate-900">Похожие товары</h2>
            {category && (
              <Link
