    ...
    <div className="flex flex-col">
      <section className="bg-neutral-950">
        <div className="container-page flex flex-col items-start gap-6 py-16 sm:py-24">
          ...
          <div className="flex flex-wrap gap-6 pt-2 text-sm text-neutral-300">
      ...
      <section className="container-page py-12">
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-xl font-bold text-neutral-900">Популярные категории</h2>
      ...
      <section className="container-page pb-16">
        <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <h2 className="text-xl font-bold text-neutral-900">Товары каталога</h2>
        ...
        <div className="mt-8 flex justify-center">
          <Link
            to="/catalog"
            className="rounded-xl border border-neutral-200 bg-white px-6 py-3 text-sm font-medium text-neutral-700 hover:border-accent-400 hover:text-accent-700"
          >
